            ...
            <div className="main-container">
                ...
                <div className="bio-container">
                    ...
                    <div className="bio-text">
                        <p className="text">Kuljit is a highly passionate technologist and committed humanitarian based in San Francisco dedicated to driving positive change in the world. </p>
                        ...
                        <p className="text">Today, Kuljit applies technology to make impactful, ethical, meaningful change in the way that we live by working exclusively with mission driven organizations that are committed to making the world a better place. </p>
