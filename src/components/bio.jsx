            ...
            <div className="main-container">
                ...
                <div className="bio-container">
                    ...
                    <div className="bio-text">
                        <p className="text">Kuljit Kaur Takhar is a highly passionate technologist and committed humanitarian based in San Francisco who is dedicated to driving positive change in the world. </p>
