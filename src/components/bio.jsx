            ...
            <div className="main-container">
                ...
                <img className="bio-img" src={Image} alt="kuljit takhar" />
                    <div clasName="bio-text">
                        <p className="text">Kuljit Kaur Takhar is a highly passionate technologist and committed humanitarian based in San Francisco who is dedicated to driving positive change in the world. She has contributed her efforts and experience to the Harvard Humanitarian Initiative by analyzing complex data sets to identify root causes of refugee crisis and recommending corrective actions. These recommendations have been instrumental in guiding governments and industries towards a more effective response to critical issues and predicting future occurrence.</p> 
                        <p clasName="text">Today, Kuljit applies technology to make impactful, ethical, meaningful change in the way that we live, and as an engineer, works exclusively with mission driven organizations that are committed to making the world a better place. </p>
